...
export const fetchShows = () => {
    const storageData = localStorage.getItem("data-bitShow");
    if (storageData) {
    ...
    return fetch("http://api.tvmaze.com/shows")
        ...
        .then((data) => {
            ...
            localStorage.setItem("data-bitShow", JSON.stringify(shows))
            return shows;
        })

}

// export const fetchFromLocalStorage = (storageData) => {
